export default {
  ...
  //POSTS
  commentComposer: {
    whoToReply: 'Yanıt Olarak',
    replyText: 'Bir şeyler yaz...',
  ...
  userProfileHeader: {
    ...
    follow: 'Takip Et',
    unfollow: 'Takibi Bırak',
    followNumber: 'Takip Edilen',
    followersNumber: 'Takipçi',
  },
  wishList: {
    makesure: 'Kaldırmak istediğine emin misin ?',
    yes: 'Evet, Lütfen',
  ...
  changePassword: {
    ...
    update: 'Hesap Şifreni Güncelle',
    warning: 'Mevcut şifreni yazıp kriterlere uymalısın.',
  ...
  edit: {
    edit: 'Profili Düzenle',
    directive: 'Bilgilerinizi Güncelleyin',
    fullName: 'Ad Soyad',
    userName: 'Kullanıcı Adı',
    birthday: 'Doğum Günü',
    bio: 'Biyografi',
  ...
  privateP: {
    ...
    fourthM: 'Kişisel Verilerin korunması için uygulanan güvenlik önlemleri,',
    fifthM: 'Üçüncü kişilere ilişkin sorumluluk sınırları,',
    sixthM: 'Kişisel Verilerinizi görüntüleme, değiştirme ve silme,',
    seventhM: 'Bu Gizlilik Bildirimindeki Değişiklikler;',
