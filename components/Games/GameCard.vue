<template>
  ...
  >
    ...
    <div class="flex flex-col my-5 space-y-3">
      <h1 class="text-xl md:text-3xl">{{ game.name }}</h1>

      <div v-if="game.company" class="flex items-center">
        <img
      ...
      <div class="flex flex-row items-center">
        <i class="bx bx-calendar text-2xl text-gray-500 dark:text-gray-500"></i>
      ...
      <div class="flex flex-row items-center">
        <i
          class="bx bx-crosshair mr-2 text-2xl text-gray-500 dark:text-gray-500"
        ></i>
      ...
      <div class="flex flex-row items-center">
        <i
          class="bx bx-customize mr-2 text-2xl text-gray-500 dark:text-gray-500"
        ></i>
        <h5 class="leading-4 text-gray-600 dark:text-gray-300">
