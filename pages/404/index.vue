<template>
  <div
    class="bg-white dark:bg-black dark:text-white min-h-screen flex flex-col items-center"
  >
    <div class="container m-auto flex flex-wrap items-center">
      <div
        class="flex justify-between absolute top-0 items-center w-full container mt-10"
      >
        <logo />
        <n-link :to="'/'">
      ...
      <div class="w-full md:w-5/12 text-center pr-20">
...
import * as animationData from '~/assets/lottie/404.json'
export default {
  components: { Logo, lottie },
  layout: 'blank',
  data() {
    return {
      anim: null,
